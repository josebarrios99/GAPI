...
defaultFont = () => {
    ...
    let newSizeBtn = sizeButton + textSize;
...
//Inputs mismos tamaño de h6
    document.querySelectorAll('.fecha').forEach(e => e.style.fontSize = newSizeP + 'px');
    document.querySelectorAll('button').forEach(e => e.style.fontSize = newSizeBtn + 'px');
...
upFont = () => {
    ...
    if (textSize < 8) {
        ...
        //document.querySelectorAll('.label').forEach(e => e.style.fontSize = newSizeP+ 'px');
